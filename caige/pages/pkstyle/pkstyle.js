...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: app.globalData.subDomain + '/Servlet/musicSelectServlet',
  ...
  scroeReq: function () {
    ...
    console.log("=================" + oid);
    wx.request({
      url: app.globalData.subDomain + '/Servlet/selectMusicScoreServlet',
  ...
  //   var that = this;
  //   wx.request({
  //     url: app.globalData.subDomain + '/Servlet/CloseStateServlet',
  //     method: "POST",
  //     header: {
  //       'content-type': 'application/x-www-form-urlencoded',
  //     },
