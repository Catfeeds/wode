...
Page({
  ...
  data: {
    ...
    showView: true,
    grade: 0,
    // imageUrlpicliangdian: app.globalData.subDomain + "/Servlet/image/liangdian.png",
    // imageUrlpicxuanyutong: app.globalData.subDomain + "/Servlet/image/xuanyutong.png",
    // imageUrlpicliquantouzi: app.globalData.subDomain + "/Servlet/image/liquantouzi.png",
    // imageUrlpicshimeijiguoji: app.globalData.subDomain + "/Servlet/image/shimeijiguoji.png",
    // imageUrlpicjinmutangquan: app.globalData.subDomain + "/Servlet/image/jinmutangquan.png",
    // imageUrlpicxingzuoguanggao: app.globalData.subDomain + "/Servlet/image/xingzuoguanggao.png",
    // imageUrlpicquanyoutongxun: app.globalData.subDomain + "/Servlet/image/quanyoutongxun.png",
  ...
  onLoad: function (e) {
    ...
    if (passnum > -1 && next) {
      ...
      next = false;
      isPlay = false;
      url = app.globalData.subDomain + '/Servlet/nextLevelServlet'
      // url = 'http://192.168.0.153:8080/Servlets/nextLevelServlet'
      // url = 'http://192.168.0.146:8080/Servlet/nextLevelServlet'
    } else {
      url = app.globalData.subDomain + '/Servlet/selectMusicByOpenid'
  ...
  toHint: function () {
    ...
    var that = this//不要漏了这句，很重要
    wx.request({
      url: app.globalData.subDomain + '/Servlet/clickTipServlet',
      headers: {
        ' -Type': 'application/json'
      },
      data: {
  ...
  onShareAppMessage: function () {
    return {
      ...
      success(e) {
        ...
        var that = this//不要漏了这句，很重要
        wx.request({
          url: app.globalData.subDomain + '/Servlet/clickShareServlet',
          headers: {
            ' -Type': 'application/json'
          },
          data: {
