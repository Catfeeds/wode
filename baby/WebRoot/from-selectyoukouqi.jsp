...
<html>
  ...
  <body>
  <form name="form5" action="YouKouQiXuanze" method="post">
	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				...
				<input name="youkouqi" type="radio" checked="checked" value="01_无口气">
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="youkouqi" type="radio" value="02_有口气">
			</div>
		</div>
	</div>
	</form>
