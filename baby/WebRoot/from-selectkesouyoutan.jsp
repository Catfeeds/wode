	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				<label>否</label>
				<input name="kesouyoutan" type="radio" checked="checked" value="01_咳嗽无痰">
				<input type="hidden" name="xuanze" value="<%=request.getParameter("xuanze")%>"/>
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="kesouyoutan" type="radio" value="02_咳嗽有痰">
			</div>
		</div>
	</div>
	</form>
