...
<meta charset="utf-8">
    ...
    <script type="text/javascript">
    	function adaptValue () {
    		...
    		if(document.getElementById("jianzhishu").value == "") {
			alert("请输入次数");
			document.getElementById("jianzhishu").focus();
			return false;
		}else{
...
<body>
	...
	<div class="mui-content">
		<form class="mui-input-group" method="post" action="JianzhiServlet" onSubmit="return adaptValue();">
			...
			<div class="mui-input-row">
				<label>减值数</label>
				<input type="text" name="jianzhishu"  id="jianzhishu" placeholder="输入次数">
			</div>
