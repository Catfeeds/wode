...
<html>
  ...
  <body>
  <form name="form2" action="GanMaoFuXieXuanze" method="post">
	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				...
				<input name="ganmaofuxie" type="radio" checked="checked" value="01_不腹泻">
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="ganmaofuxie" type="radio" value="02_腹泻">
			</div>
		</div>
	</div>
	</form>
