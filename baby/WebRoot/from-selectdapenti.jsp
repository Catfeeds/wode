	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				<label>否</label>
				<input name="dapenti" type="radio" checked="checked" value="01_不打喷嚏">
				<input type="hidden" name="xuanze" value="<%=request.getParameter("xuanze")%>"/>
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="dapenti" type="radio" value="02_打喷嚏">
			</div>
		</div>
	</div>
	</form>
