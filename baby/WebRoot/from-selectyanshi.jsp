...
<html>
  ...
  <body>
  <form name="form2" action="YanShiXuanze" method="post">
	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				...
				<input name="yanshi" type="radio" checked="checked" value="01_不厌食">
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="yanshi" type="radio" value="02_厌食">
			</div>
		</div>
	</div>
	</form>
