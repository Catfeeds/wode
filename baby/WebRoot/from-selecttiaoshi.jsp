...
<html>
  ...
  <body>
  <form name="form2" action="TiaoShiXuanze" method="post">
	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				...
				<input name="tiaoshi" type="radio" checked="checked" value="01_不挑食">
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="tiaoshi" type="radio" value="02_挑食">
			</div>
		</div>
	</div>
	</form>
