...
<body>
	...
	<div class="mui-content">
		<div class="my-txt-box" style="padding: 20px;">
			<span class="my-low-bt">宝宝姓名：</span>${patient.pname }
		</div>
		
		<ul class="mui-table-view">
			<c:forEach items="${recordList }" var="record">
				<li class="mui-table-view-cell">
					<a class="mui-navigate-right" href="RecordShowServlet?pid=${patient.pid}&rid=${record.cid }">
						<span class="mui-badge my-list-wz">${record.ctime }</span>
						${record.dycf }
					</a>
				</li>
			</c:forEach>
