	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				<label>否</label>
				<input name="mcyfmwd" type="radio" checked="checked" value="01_目赤眼分泌物正常">
				<input type="hidden" name="xuanze" value="<%=request.getParameter("xuanze")%>"/>
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="mcyfmwd" type="radio" value="02_目赤眼分泌物增多">
			</div>
		</div>
	</div>
	</form>
