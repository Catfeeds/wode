	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				<label>不消化物</label>
				<input name="xingzhuang" type="radio" checked="checked" value="01_不消化物">	
				<input type="hidden" name="xuanze" value="<%=request.getParameter("xuanze")%>"/>
			</div>
			<div class="mui-input-row mui-radio">
				<label>糊状</label>
				<input name="xingzhuang"  type="radio" value="02_糊状" >
			</div>
			<div class="mui-input-row mui-radio">
				<label>蛋花状</label>
				<input name="xingzhuang" type="radio" value="03_蛋花状">
			</div>
			<div class="mui-input-row mui-radio">
				<label>水样</label>
				<input name="xingzhuang" type="radio" value="04_蛋花状">
			</div>
			<div class="mui-input-row mui-radio">
				<label>脓状物</label>
				<input name="xingzhuang" type="radio" value="05_蛋花状">
			</div>
		</div>
	</div>
	</form>
