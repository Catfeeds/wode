	...
	<!-- <div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				<label>正常</label>
				<input name="wenzhen" type="radio" checked="checked" value="01_正常">
				<input type="hidden" name="xuanze" value="<%=request.getParameter("xuanze")%>"/>
			</div>
			<div class="mui-input-row mui-radio">
				<label>大便臭</label>
				<input name="wenzhen" type="radio" value="01_臭">
			</div>
			<div class="mui-input-row mui-radio">
				<label>大便酸臭</label>
				<input name="wenzhen" type="radio" value="02_酸臭">
			</div>
			<div class="mui-input-row mui-radio">
				<label>大便腥味</label>
				<input name="wenzhen" type="radio" value="03_腥味">
			</div>
		</div>
	</div>
	 -->
	 ...
	 <div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				<label>否</label>
				<input name="biantaoti" type="radio" checked="checked" value="01_扁桃体不肿大">
				<input type="hidden" name="xuanze" value="<%=request.getParameter("xuanze")%>"/>
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="biantaoti" type="radio" value="02_扁桃体肿大">
			</div>
		</div>
	</div>
	</form>
