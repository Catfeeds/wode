...
<html>
  ...
  <body>
  <form name="form2" action="BiSaiXuanze" method="post">
	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				...
				<input name="bisai" type="radio" checked="checked" value="01_不鼻塞">
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="bisai" type="radio" value="02_鼻塞">
			</div>
		</div>
	</div>
	</form>
