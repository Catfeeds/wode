...
<html>
  ...
  <body>
  <form name="form2" action="KeChuanXuanze" method="post">
	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				...
				<input name="kechuan" type="radio" checked="checked" value="01_不咳喘">
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="kechuan" type="radio" value="02_咳喘">
			</div>
		</div>
	</div>
	</form>
