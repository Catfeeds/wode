...
<html>
  ...
  <body>
  <form name="form2" action="BttzdXuanze" method="post">
	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				...
				<input name="bttzd" type="radio" checked="checked" value="01_扁桃体不肿大">
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="bttzd" type="radio" value="02_扁桃体肿大">
			</div>
		</div>
	</div>
	</form>
