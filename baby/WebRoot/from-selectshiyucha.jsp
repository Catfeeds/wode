...
<html>
  ...
  <body>
  <form name="form2" action="ShiYuChaXuanze" method="post">
	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				...
				<input name="shiyucha" type="radio" checked="checked" value="01_食欲不差">
			</div>
			<div class="mui-input-row mui-radio">
				<label>是</label>
				<input name="shiyucha" type="radio" value="02_食欲差">
			</div>
		</div>
	</div>
	</form>
