	...
	<div class="mui-content">
		<div class="mui-input-group">
			<div class="mui-input-row mui-radio">
				<label>正常</label>
				<input name="qiwei" type="radio" checked="checked" value="01_正常">
				<input type="hidden" name="xuanze" value="<%=request.getParameter("xuanze")%>"/>
			</div>
			<div class="mui-input-row mui-radio">
				<label>大便臭</label>
				<input name="qiwei" type="radio" value="01_臭">
			</div>
			<div class="mui-input-row mui-radio">
				<label>大便酸臭</label>
				<input name="qiwei"  type="radio" value="02_酸臭" >
			</div>
			<div class="mui-input-row mui-radio">
				<label>大便腥味</label>
				<input name="qiwei" type="radio" value="03_腥味">
			</div>
		</div>
	</div>
	</form>
