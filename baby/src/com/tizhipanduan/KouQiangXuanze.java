 ...
 *
 */
public class KouQiangXuanze extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String kouqiang=request.getParameter("kouqiang");
		System.out.println("k口腔--------------"+kouqiang);
		if(kouqiang==null || kouqiang == ""){
			kouqiang="01_正常";
		}
		String[] strkouqiang = kouqiang.split("_");
		String str2kouqiang = strkouqiang[1];
