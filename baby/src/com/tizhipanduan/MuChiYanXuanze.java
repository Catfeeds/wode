 ...
 *
 */
public class MuChiYanXuanze extends  HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String mcyfmwd=request.getParameter("mcyfmwd");
		
		if(mcyfmwd==null || mcyfmwd == ""){
			mcyfmwd="01_目赤眼分泌物正常";
		}
		String[] strmcyfmwd = mcyfmwd.split("_");
		String str2mcyfmwd = strmcyfmwd[1];
